...
%%% запрет на лигатуры в английских словах: Использование лигатур создаёт проблемы с кодировкой и, соответственно, поиском/копированием текста в некоторых системах. 
\usepackage{microtype}
\DisableLigatures[i,f,l,t]{encoding = *, family = *}
