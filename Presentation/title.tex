...
\author{%
    \texorpdfstring{%
        ...
        \emph{Научный руководитель:}\\~\supervisorRegaliaShort~\supervisorFio\\%
        %
    }{\thesisAuthor}%
}
...
\subtitle{Представление на соискание учёной степени \\
    \thesisDegree\ по специальности \thesisSpecialtyNumber\ \\
    \thesisSpecialtyTitle}
